...
HTTP_URL = "http://127.0.0.1:8080/download/LA4CS-Chapter-11.pdf"
HTTPS_URL = "https://127.0.0.1:8443/download/LA4CS-Chapter-11.pdf"
...
print("Testing HTTP bandwidth:")
test_bandwidth(HTTP_URL)

# Run the test for HTTPS
print("Testing HTTPS bandwidth:")
